...
// ── Render frame SVG around avatar — use in JSX files ─────────────────────────
// Import this and use: <FrameSVG frame={frame} size={80}>{children}</FrameSVG>
// Since this is a .js file, the actual component is in frames.jsx
